    ...
    const checkUserAndFetchAllergies = async () => {
      const fetchAllergies = async () => {
        try {
          ...
          setOtherAllergies({
            otherFoodAllergies:
              otherAllergiesResponse.data.other_food_allergies || "",
            otherEnvironmentalAllergies:
              otherAllergiesResponse.data.other_environmental_allergies || "",
            otherMedicationAllergies:
              otherAllergiesResponse.data.other_medication_allergies || "",
          });
          // } else {
  ...
  return (
    <div className="allergies-page">
      ...
      <div className="allergy-container">
        <ul
          className="item-list"
          aria-label={`List of my allergies`}
          tabIndex="-1"
          ref={listRef}
        >
          <li
            className={`allergies-category ${
              openCategory === "food" ? "expanded" : ""
            }`}
          ...
          >
            <div className="allergies-category-header">
              Food Allergies
              <img
                src={openCategory === "food" ? upImg : downImg}
                alt={
                  openCategory === "food"
                    ? "Click to close the food allergies"
                    : "Click to expand the food allergies"
                }
              />
            </div>
            {openCategory === "food" && (
              <div
                className="allergies-category-content"
                aria-label="List of food alergies"
              >
                {allergies
                  .filter((allergy) => allergy.type === "food")
                  .map((allergy) => (
                ...
                {otherAllergies.otherFoodAllergies
                  .split(",")
                  .map((allergy, index) => (
                    <div key={`other-food-${index}`} className="allergy-item">
                      {allergy}
                    </div>
                  ))}
              </div>
          ...
          <li
            className={`allergies-category ${
              openCategory === "environmental" ? "expanded" : ""
            }`}
          ...
          >
            <div className="allergies-category-header">
              ...
              <img
                src={openCategory === "environmental" ? upImg : downImg}
                alt={
                  openCategory === "environmental"
                    ? "Click to close the environmental allergies"
                    : "Click to expand the environmental allergies"
                }
              />
            </div>
            {openCategory === "environmental" && (
              <div
                className="allergies-category-content"
                aria-label="List of environmental alergies"
              >
                {allergies
                  .filter((allergy) => allergy.type === "environmental")
                  .map((allergy) => (
                    <div key={allergy.id} className="allergy-item">
                      {allergy.title}
                    </div>
                  ))}
                {otherAllergies.otherEnvironmentalAllergies
                  .split(",")
                  .map((allergy, index) => (
                    <div
                      key={`other-environmental-${index}`}
          ...
          <li
            className={`allergies-category ${
              openCategory === "medication" ? "expanded" : ""
            }`}
            onClick={() => toggleCategory("medication")}
          >
            <div className="allergies-category-header">
              Medication Allergies
              <img
                src={openCategory === "medication" ? upImg : downImg}
                alt={
                  openCategory === "medication"
                    ? "Click to close the medication allergies"
                    : "Click to expand the medication allergies"
                }
              />
            </div>
            {openCategory === "medication" && (
              <div
                className="allergies-category-content"
                aria-label="List of medication alergies"
              >
                {allergies
                  .filter((allergy) => allergy.type === "medication")
                  .map((allergy) => (
                    <div key={allergy.id} className="allergy-item">
                      {allergy.title}
                    </div>
                  ))}
                {otherAllergies.otherMedicationAllergies
                  .split(",")
                  .map((allergy, index) => (
                    <div
                      key={`other-medication-${index}`}
                      className="allergy-item"
                    >
                      {allergy}
                    </div>
