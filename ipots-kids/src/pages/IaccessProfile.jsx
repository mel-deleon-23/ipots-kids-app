...
export default function IaccessProfile() {
  ...
  return (
    <div className="App">
      <div className="profile-container">
        ...
        <div>
          <p className="profileInfor">{profileData.firstname}</p>
        </div>
        <div>
          <p className="profileInfor">{profileData.lastname}</p>
        </div>
        <div>
      ...
      <div className="d-flex flex-column justify-content-center align-items-center">
        ...
        >
          <button className=" button-format buttonColor"> Back</button>
        </Link>
      </div>
    </div>
  );
